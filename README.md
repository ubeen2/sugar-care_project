...
<p align="center">
  ...
  <br>
  <em>슬라이드 10.혈당 스파이크 유지 시간 확인 120분 기준 설정</em>
</p>


---

### 11️⃣ 최소 성능 확인(베이스라인 설정)
<p align="center">
...
**설명:**  
(예: 모델이 120분 예측 하기 때문에 120분 기준으로 42보다 더 낮은 수치의 성능을 가진 모델을 만들어야 됩니다.)
...
* 유튜브 시연 영상 : (유튜브채널 - https://youtu.be/Nt6PhylsvMs?si=eL5J2XsRUkD_1Fhn)
